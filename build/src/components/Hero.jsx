...
export default function Hero() {
    return (
        <motion.section id="hero" class="mb-28 font-poppins"
            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div class="mx-auto lg:mr-auto place-self-center lg:col-span-7">
                        <h1 class="text-center lg:text-left max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl ">Master The Arabic Language With <span className="text-green">Ramadan</span></h1>
                        <p class="text-center lg:text-left max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Begin with the Arabic alphabet, dive into grammar, and with tailored lessons from Ramadan to achieve fluency in no time.</p>

                        <motion.div

                            class="flex flex-col space-y-4 sm:flex-row justify-center lg:justify-start sm:space-y-0 ">
                            <motion.a whileInView="show"
                                whileHover={{ scale: 1.1 }} href="#" className="mx-auto lg:mx-0 items-center py-3 px-5 text-base font-medium text-white rounded-lg bg-green hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 ">
                                Book A Class Now
                            </motion.a>
