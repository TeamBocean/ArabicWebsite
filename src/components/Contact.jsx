    ...
    <div className="-mx-4 flex flex-wrap lg:justify-between">
      <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
        <div className="mb-12 max-w-[570px] lg:mb-0">
          <span className="mb-4 text-4xl tracking-tight font-extrabold text-green dark:text-white">Contact Me</span>
          
          <p className="text-body-color mb-9 mt-9 text-base leading-relaxed">
          Have questions or need assistance with your Arabic learning journey? Feel free to reach out to me. I'm here to help. Contact me using the information below.
          </p>
          ...
          <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full">
              ...
              <p className="text-body-color text-base">(087) 141 7827</p>
            </div>
          </div>
          <div className="mb-8 flex w-full max-w-[370px]">
            <div
            ...
            <div className="w-full">
              ...
              <p className="text-body-color text-base">Rumdan@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
