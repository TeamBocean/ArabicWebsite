    ...
    <div class="-mx-4 flex flex-wrap lg:justify-between">
      <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
        <div class="mb-12 max-w-[570px] lg:mb-0">
          <span class="mb-4 text-4xl tracking-tight font-extrabold text-green dark:text-white">Contact Me</span>
          
          <p class="text-body-color mb-9 mt-9 text-base leading-relaxed">
          ...
          <div class="mb-8 flex w-full max-w-[370px]">
            ...
            <div class="w-full">
              <h4 class="text-dark mb-1 text-xl font-bold">Location</h4>
              <p class="text-body-color text-base"> Islamic Cultural Centre Of Ireland, 19 Roebuck Rd, Friarland, Dublin 14,<br /> D14 YD91</p>
            </div>
          </div>
          <div class="mb-8 flex w-full max-w-[370px]">
            <div
            ...
            <div class="w-full">
              ...
              <p class="text-body-color text-base">(087) 141 7827</p>
            </div>
          </div>
          <div class="mb-8 flex w-full max-w-[370px]">
            <div
            ...
            <div class="w-full">
              ...
              <p class="text-body-color text-base">Rumdan@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
