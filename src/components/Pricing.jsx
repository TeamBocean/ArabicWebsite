...
<section id="pricing" className="mb-28 ">
 ...
 <svg className="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Leaving Cert Plan */}
              <motion.div variants={fadeIn('right', 'spring', 0.5, 0.75)} initial="hidden" whileInView="show"  whileHover={{ scale: 1.1 }}  transition={{ type: "spring", stiffness: 400, damping: 10 }} className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-green rounded-lg border border-gray-100 shadow dark:border-gray-600 lg:p-10 dark:bg-gray-800 dark:text-white ">
                ...
                <div className="flex justify-center items-baseline my-8">
                  ...
                  <ul role="list" className="mb-4 space-y-4 text-left text-white">
                      <li className="flex items-center space-x-3">
                        <svg className="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
